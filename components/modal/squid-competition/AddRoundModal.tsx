        ...
        if (ctx) {
          ...
          const qr = await QRCode.toDataURL(
            `{
              ...
              currentPlayers: ${roundLevel > 1 ? numberOfWinnersOfThisRound : playersInThisPhase},
            }`,
            opts
          )
          ...
          ctx.fillText(`${roundLevel > 1 ? numberOfWinnersOfThisRound : playersInThisPhase}/${totalPlayers}`, 290, 540)

        ...
        if (ctx) {
          ...
          const qr = await QRCode.toDataURL(
            `{
              ...
              currentPlayers: ${roundLevel > 0 ? numberOfWinnersOfThisRound : playersInThisPhase},
            }`,
            opts
          )
          ...
          ctx.fillText(`${roundLevel > 0 ? numberOfWinnersOfThisRound : playersInThisPhase}/${totalPlayers}`, 290, 540)

    ...
    testnet: {
      mumbaiChainId: {
        ...
        contractAddressForNativeToken:
          contractAddressesInDailyBets[mumbaiChainId][0],
        contractAddressForUtbetsToken:
          contractAddressesInDailyBets[mumbaiChainId][1],
      },
      bscTestnetChainId: {
        ...
        contractAddressForNativeToken:
          contractAddressesInDailyBets[bscTestnetChainId][0],
        contractAddressForUtbetsToken:
          contractAddressesInDailyBets[bscTestnetChainId][1],
      },
      arbitrumGoerliChainId: {
        chainId: arbitrumGoerliChainId,
        rpc: (chainRPCs as any)[arbitrumGoerliChainId],
        contractAddressForNativeToken:
          contractAddressesInDailyBets[arbitrumGoerliChainId][0],
        contractAddressForUtbetsToken:
          contractAddressesInDailyBets[arbitrumGoerliChainId][1],
      },
      fujiChainId: {
        chainId: fujiChainId,
        ...
        contractAddressForNativeToken:
          contractAddressesInDailyBets[fujiChainId][0],
        contractAddressForUtbetsToken:
          contractAddressesInDailyBets[fujiChainId][1],
      },
    },
    ...
    Object.values(currentChainParams).map(async (chainParam: any) => {
      ...
      await contracts.reduce(async (promise1, contractItem, _2) => {
        ...
        try {
          ...
          const unsignedTx = await contract.populateTransaction.cancelEvent(
            data.eventID
          )
